    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="filtros">
                ...
                <a href="gerar-planilha.php" name="tipoUser" class="btn btn-success">Exportar Excel</a>
            </div>
                            ...
                            <?php
                                ...
                                if($tipoUsuario==1){
                                    ...
                                    if(isset($_POST['filtro']) && ( empty($_POST['codForn'])==false || empty($_POST['dataInicial'])==false || empty($_POST['dataFinal'])==false)) {
                                        ...
                                        if($sql->rowCount()>0){
                                            ...
                                            foreach($dados as $dado){
                                                ...
                                                echo "<td class='text-center align-middle'>
                                                 <button name='editar' type='submit'><img src='assets/images/delet.png'></button>
                                                 <input type='submit' value='Excluir' class='btn btn-danger' name='excluir'>
                                                 </td>";
                                                echo '</tr>';
                                                echo "</form>";
                                        ...
                                        //qtde maxima por página
                                        $qtdeItens = 1;

                                        //calcular numero de páginas necessarias
                                        $numPaginas = ceil($numRegistros/$qtdeItens);

                                        //calcular o inicio da visualização
                                        $inicio = ($qtdeItens*$pagina)-$qtdeItens;

                                        //selecionar o que vai ser exibido
                                        $limitado = $db->query("SELECT * FROM movimentacoes INNER JOIN usuarios ON usuarios.codInt = movimentacoes.codForn LIMIT $inicio, $qtdeItens");
                                        $numMovimentatcoes = $limitado->rowCount();
            ...
            ?>
                <nav aria-label="Navegação de página exemplo">
                    <ul class="pagination justify-content-center">
                        ...
                        <?php
                            if($anterior != 0){
                                echo"   <a class='page-link' href='index.php?pagina=$anterior' aria-label='Anterior'>
                                            <span aria-hidden='true'>&laquo;</span>
                                            <span class='sr-only'>Anterior</span>
                                        </a>";
                            }else{
                                echo "<a class='page-link' href aria-label='Anterior'>
                                        <span aria-hidden='true'>&laquo;</span>
                                        <span class='sr-only'>Anterior</span>
                                        </a>";
                            }
                        ...
                        <?php
                            ...
                            if($proximo <= $numPaginas){
                                echo "<a class='page-link' href='index.php?pagina=$proximo' aria-label='Próximo'>
                                        <span aria-hidden='true'>&raquo;</span>
                                        <span class='sr-only'>Próximo</span>
                                    </a>";
                            }else{
                                echo "<a class='page-link' href aria-label='Próximo'>
                                        <span aria-hidden='true'>&raquo;</span>
                                        <span class='sr-only'>Próximo</span>
                                    </a>";
                            }
